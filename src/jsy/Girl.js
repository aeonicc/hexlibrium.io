...
import { Vehicle, Think, ArriveBehavior, ObstacleAvoidanceBehavior } from '../libs/yuka/yuka.module.js';
...
class Girl extends Vehicle {
	...
	constructor( mixer, animations ) {
		...
		// const obstacleAvoidanceBehavior = new ObstacleAvoidanceBehavior( obstacles );
